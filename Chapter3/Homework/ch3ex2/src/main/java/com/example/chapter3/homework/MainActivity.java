...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, "scaleX", 1, 2, 1);
        scaleX.setDuration(2000);
        scaleX.start();
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(target, "scaleY", 1, 2, 1);
        scaleX.setDuration(2000);
        scaleX.start();

        // TODO 2：在这里实现另一个 ObjectAnimator，对 target 控件的透明度进行修改，从 1 到 0.5f 循环
        ObjectAnimator alpha = ObjectAnimator.ofFloat(target,"alpha",1,0.5f,1);
